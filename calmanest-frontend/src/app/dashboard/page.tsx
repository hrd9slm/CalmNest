...
const Page = () => {
  ...
  const [isPostsSectionVisible, setIsPostsSectionVisible] = useState(false);
  ...
  const handlePostsClick = (e: MouseEvent<HTMLAnchorElement>) => {
    e.preventDefault();
    setIsPostsSectionVisible(!isPostsSectionVisible);
  };
