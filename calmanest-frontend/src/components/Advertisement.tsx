        ...
        return (
          <div className="font-[sans-serif]">
            <div className="max-w-5xl max-lg:max-w-3xl mx-auto">
              ...
              <div className="grid lg:grid-cols-1 sm:grid-cols-1 gap-6 mt-6 max-sm:max-w-sm max-sm:mx-auto m-3">
                <div className="shadow-[0_2px_22px_-4px_rgba(93,96,127,0.2)] rounded-lg overflow-hidden transition-all duration-500 hover:scale-105">
                  <div className="h-32 bg-light-pink text-center p-4">
                  ...
                  <div className="px-6 py-4 mt-4">
                    ...
                    <button
                      type="button"
                      className="w-full mt-8 px-5 py-2.5 text-sm  text-white border-2 border-light-pink bg-light-pink transition-all ease-in-out duration-300 hover:bg-transparent hover:text-light-pink rounded-full"
                    >
                      Get Started
                    </button>
                  </div>
